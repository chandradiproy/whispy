      ...
      <nav className="flex flex-col gap-2 p-4 flex-1">
        {Array(15)
          ...
          .map((_, index) => (
            <div
              key={index}
              className="flex items-center gap-3 p-3 rounded-lg bg-gray-600/10 animate-pulse"
            >
              <div className="h-6 w-6 bg-gray-700/30 rounded-full"></div>
              <div className="h-4 w-32 bg-gray-700/30 rounded-md"></div>
            </div>
          ))}
      </nav>
